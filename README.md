...
2. **Stage 2 — Cross-encoder reranking** — `BAAI/bge-reranker-v2-m3` (560MB) processes each candidate as a query+document pair through a transformer, producing a far more accurate relevance score. The top 60 are reranked and only the best 5-8 are returned.
